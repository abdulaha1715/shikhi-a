!(function () {
    ...
    function y(e) {
        document.getElementById("header-lang-img") &&
            ("en" == e
                ? (document.getElementById("header-lang-img").src = "/backend/assets/images/flags/us.svg")
                : "sp" == e
                ? (document.getElementById("header-lang-img").src = "/backend/assets/images/flags/spain.svg")
                : "gr" == e
                ? (document.getElementById("header-lang-img").src = "/backend/assets/images/flags/germany.svg")
                : "it" == e
                ? (document.getElementById("header-lang-img").src = "/backend/assets/images/flags/italy.svg")
                : "ru" == e
                ? (document.getElementById("header-lang-img").src = "/backend/assets/images/flags/russia.svg")
                : "ch" == e
                ? (document.getElementById("header-lang-img").src = "/backend/assets/images/flags/china.svg")
                : "fr" == e && (document.getElementById("header-lang-img").src = "/backend/assets/images/flags/french.svg"),
